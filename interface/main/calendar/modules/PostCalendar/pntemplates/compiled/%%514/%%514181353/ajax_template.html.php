...
array('function', 'assign', 'default/views/day/ajax_template.html', 331, false),
array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 336, false),
array('modifier', 'date_format', 'default/views/day/ajax_template.html', 331, false),
array('modifier', 'string_format', 'default/views/day/ajax_template.html', 332, false),)); ?>
...
/leftbtn.gif" border="0" title="<?php echo xl("Previous Day") ?>" alt="<?php echo xl ("Previous Day") ?>" /></a>
...
<div id="viewPicker">
<img id="printview" src="<?php echo $this->_tpl_vars['TPL_IMAGE_PATH']; ?>
/print.gif" border="0" title="<?php echo xl("Print View") ?>" alt="<?php echo xl ("Print View") ?>" />
&nbsp;
<img id="dayview" class="currentview" src="<?php echo $this->_tpl_vars['TPL_IMAGE_PATH']; ?>
/day.gif" border="0" title="<?php echo xl("Day View") ?>" alt="<?php echo xl ("Day View") ?>" />
&nbsp;
<img id="weekview" src="<?php echo $this->_tpl_vars['TPL_IMAGE_PATH']; ?>
/week.gif" border="0" title="<?php echo xl ("Week View") ?>" alt="<?php echo xl ("Week View") ?>" />
&nbsp;
<img id="monthview" src="<?php echo $this->_tpl_vars['TPL_IMAGE_PATH']; ?>
/month.gif" border="0" title="<?php echo xl ("Month View") ?>" alt="<?php echo xl ("Month View") ?>" />
</div>
...
foreach ($times as $slottime) {
    ...
    echo "<a href='javascript:newEvt($startampm,$starttimeh,$starttimem,$Date,$providerid,0)' title='" . xl('New Appointment') . "' alt='New Appointment'>";
...
foreach ($providers as $provider) {
    ...
    echo "<td class='schedule' title='".$provider['fname']." ".$provider['lname']."'>";
	    ...
	    $fname = substr($event['patient_name'], $commapos + 2);
            ...
            if ($catid == 2 || $catid == 3 || $catid == 4 || $catid == 8 || $catid == 11) {
                ...
                $divTitle .= "\r\n[".$catname ."] " . htmlspecialchars($fname, ENT_QUOTES) . " " . htmlspecialchars($lname, ENT_QUOTES) .
                 " | " . xl("Comment") . ":" . htmlspecialchars($comments, ENT_QUOTES) . " ";
